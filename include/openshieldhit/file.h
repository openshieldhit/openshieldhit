#ifndef OPENSHIELDHIT_FILE_H
#define OPENSHIELDHIT_FILE_H
 ...
 *
 * @details
 * Parser-oriented helper used by applications and importers that need stable
