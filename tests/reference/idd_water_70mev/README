IDD benchmark — 70 MeV protons in water
==========================================

Pencil beam of 70 MeV protons on a water cylinder (R = 20 cm, L = 8 cm),
scoring the laterally integrated energy deposition (IDD) on a 1D depth mesh
(160 bins over 0..8 cm).  Straggling: Gauss; MCS: Moliere; NUCRE on;
