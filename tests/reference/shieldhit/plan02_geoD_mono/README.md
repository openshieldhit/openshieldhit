SH12A gold-standard fixture set: plan02 geoD mono
=================================================

Curated from:
  https://github.com/APTG/2022_DCPT_LET/tree/main/data/sh12a/results/plan02_field01_geoD_mono
...
- The same file inventory applies to `plan01_geoA_sobpcent`.
