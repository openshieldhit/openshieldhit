SHIELD-HIT12A run decks — 200 MeV protons in water, MSCAT 2 (Moliere; the case the issue is about)
==================================================================================================

These test decks are made for SHIELD-HIT12A, used as the external reference code
for openshieldhit.

SHIELD-HIT12A-syntax mirror of tests/reference/idd_water_200mev_scat2 (the
...
column and drop it into
  ../../idd_water_200mev_scat2/reference/idd_sh12a.dat
