IDD benchmark — 150 MeV protons in water
==========================================

Pencil beam of 150 MeV protons on a water cylinder (R = 20 cm, L = 18 cm),
scoring the laterally integrated energy deposition (IDD) on a 1D depth mesh
(180 bins over 0..18 cm).  Straggling: Gauss; MCS: Moliere; NUCRE on;
