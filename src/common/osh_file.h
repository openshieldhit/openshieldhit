 ...
 *
 * @details This function opens a file in read mode and initializes an oshfile_t structure.
 *
 ...
 * @details This function closes the file associated with the oshfile_t structure,
 *         frees the allocated memory for the filename, and deallocates the oshfile_t structure
 ...
 *
 * @details This function returns the current line number based on the file pointer position.
 *          It uses a binary search on the map of line offsets to find the correct line number.
 *
