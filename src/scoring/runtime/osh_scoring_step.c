...
/* All per-estimator score_step_* deposit handlers are declared in
 * osh_scoring_step_internal.h and registered in osh_scoring_estimator.c; they are
 * extern so the estimator registry can reference them. */
